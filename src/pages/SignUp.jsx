...
function SignUp() {
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 to-indigo-100 px-4 py-10">
      <div className="bg-white p-8 rounded-xl shadow-2xl w-full max-w-xl md:max-w-2xl lg:max-w-3xl border border-gray-100 overflow-y-auto max-h-screen">
        ...
        {/* <div className="flex justify-center mb-6">
          <button className="flex items-center py-2 px-4 border border-gray-300 rounded-lg bg-white hover:bg-gray-50 transition-colors shadow-sm">
        ...
        {/* Footer */}
        <p className="text-sm text-center text-gray-600 top-0.5">
          Already have an account?{' '}
          <Link to="/signin" className="text-blue-600 hover:text-blue-800 font-medium transition-colors">
            Sign in
          </Link>
        </p>
