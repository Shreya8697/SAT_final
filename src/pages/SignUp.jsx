...
function SignUp() {
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 to-indigo-100 px-4 py-10">
      <div className="bg-white p-8 rounded-xl shadow-2xl w-full max-w-3xl lg:w-3/4 border border-gray-100">
        ...
        <div className="items-center mb-6">
          <button className="flex items-center justify-center py-2 px-4 border border-gray-300 rounded-lg bg-white hover:bg-gray-50 transition-colors">
